...
const GOOGLE_SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbziieTyEB2_P9_7dQGwkBBLUfClHUmMbic6TgHHmtaG54xGUWjvP5_QbLgaMEntitv_/exec";
const FORM_SUBMIT_EMAIL = "https://formsubmit.co/raviraj17a@gmail.com";

const eventOptions = [
  { label: "The Human Algorithm", value: "online event" },
    ...
    <>
      ...
      <footer className="footer">
        <div style={{ marginBottom: "1rem", display: "flex", gap: "12px", justifyContent: "center" }}>
          <a href="#" className="social-link" style={{ borderColor: 'rgba(225, 48, 108, 0.2)', color: '#E1306C' }}>
            <Instagram size={20} />
          </a>
          <a href="#" className="social-link" style={{ borderColor: 'rgba(37, 211, 102, 0.2)', color: '#25D366' }}>
            {/* WhatsApp SVG */}
          ...
          <a href="#" className="social-link" style={{ borderColor: 'rgba(0, 119, 181, 0.2)', color: '#0077b5' }}>
            <Linkedin size={20} />
          </a>
        </div>
